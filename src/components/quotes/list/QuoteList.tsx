...
import OrderDeleteModal from "../../orders/modals/OrderDeleteModal"
import OrderActionMenu from "../../orders/list/OrderActionMenu"
        ...
        >
            {({ renderContent, items, ...listViewChildProps }) => (
                <Container maxW="100%" bgColor="st.mainBackgroundColor" flexGrow={1} p={[4, 6, 8]}>
                    <Box>
                        <QuoteListToolbar {...listViewChildProps} onBulkEdit={editDisclosure.onOpen} />
                    </Box>
                    {renderContent}
                    <OrderDeleteModal
